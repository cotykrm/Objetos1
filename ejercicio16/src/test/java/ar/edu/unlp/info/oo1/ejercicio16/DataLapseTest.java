...
public class DataLapseTest {
    ...
    DataLapse lap;
    DataLapse lapCruceInf;
    DataLapse lapCruce;
    DataLapse lapCruceSup;


    @BeforeEach
    void setUp(){
        lap = new DataLapse(LocalDate.of(2004,07,15), LocalDate.of(2005,06,16));
        lapCruceInf = new DataLapse(LocalDate.of(2004,07,15), LocalDate.of(2004,07,15));
        lapCruce = new DataLapse(LocalDate.of(2005,06,16), LocalDate.of(2004,07,15));
        lapCruceSup = new DataLapse(LocalDate.of(2005,06,16), LocalDate.of(2005,06,16));
